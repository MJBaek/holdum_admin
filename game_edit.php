        								...
        								<div class="row">
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              <label class="bmd-label-floating">게임아이디</label>
                                              <input type="text" class="form-control" name="game_id"  value="<?php echo $_GET[game_id];?>" readonly>
                                            </div>
                                          </div>
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              <label class="bmd-label-floating">게임제목</label>
                                              <input type="text" class="form-control" name="game_title" value="<?php echo $row[game_title];?>">
                                            </div>
                                          </div>
                                          <div class="col-md-12">
                                            <div class="form-group">
                                          ...
                                          <div class="col-md-12">
                                            <div class="form-group">
											  ...
											  <input type="text" class="form-control datetimepicker"  id="game_start"  name="game_start" value="<?php echo $row[game_start]?>"/>
                                            </div>
                                          </div>
                                          <div class="col-md-12">
                                            <div class="form-group">
